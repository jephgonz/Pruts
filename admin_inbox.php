            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <a href='admin_ticket_log.php' class="btn btn-success btn-sm m-0 waves-effect"><i class="fa fa-clipboard-list"></i> Action Logs</a>
                            <br></br>
                            <div id="work-collections">
                                <ul id="projects-collection" class="collection">
                                    <?php
                                    $res = mysqli_query($conn, "SELECT * FROM `tickets` WHERE 1;");
                                    while ($row = mysqli_fetch_array($res)) {
                                        echo '<a href="admin_view_messages.php?id=' . $row['ticketId'] . '"class="collection-item">
                                        <div class="row">
                                        <div class="col s6">
                                            <p class="collections-title">' . $row['fname'] . '</p>                                              
                                        </div>
