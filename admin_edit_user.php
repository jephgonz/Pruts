...
$user_id = $_GET['id']; //get id from admin_products
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            ...
                            if (isset($_POST['btn'])) {
                                ...
                                $sql = "UPDATE customer SET fname = '$fname', mname = '$mname', lname = '$lname', contactno = '$contact', address = '$address', username = '$username', password = '$password' WHERE customerId = '$user_id'";
