                ...
                <div class="container-fluid">
                    ...
                    <div>
                        <div class="card shadow mb-4">
                            <div class="card-body">
                            <button id="add" data-toggle="modal" data-target="#addModal" class="btn btn-success btn-sm m-0 waves-effect"><i class="fa fa-plus"></i> Add Listing</button>
                            <br><br>
                                <?php $res = mysqli_query($conn, "SELECT * FROM fruit ORDER BY fruitId"); ?>
                                        ...
                                        <tbody>
                                            <?php while ($row = mysqli_fetch_assoc($res)) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="admin_edit_listing.php?id=<?php echo $row['fruitId']; ?>" class="btn btn-primary btn-sm m-0 waves-effect"><i class="fa fa-edit"></i></a>

                                                        <a href="admin_delete_listing.php?id=<?php echo $row['fruitId']; ?>" class="btn btn-danger btn-sm m-0 waves-effect"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                <?php } ?>
                                        </tbody>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            if (isset($_POST['btn'])) {
                $name = $_POST['name'];
                $price = $_POST['price'];
                $sql = "INSERT INTO fruit (name, pricePerKilo)
							VALUES ('$name', '$price')";
