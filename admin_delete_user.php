...
$user_id = $_GET['id']; //get id from admin_users
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <?php
                            ...
                            ?>
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h1 class="h3 mb-0 text-gray-800">Are you sure you want to delete <span style="color:#cc0000"><?php echo $row['fname']; ?></span> from users?</h1>
                            </div>
                            <form method="post">
                            <input type="hidden" name="oid" value="<?php echo $user_id ?>"></input>
                            <a href='admin_users.php' class="btn btn-success">Cancel</a>
                            <button class="btn btn-danger" type="submit" name="dbtn">Delete</button>
                            </form>
                            <?php
                            if (isset($_POST['dbtn'])) {
                                $oid = $_POST['oid'];
                                $sql = "DELETE FROM customer WHERE customerId = '$oid'";
