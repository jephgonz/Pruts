            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Hello <?php echo $row['fname']; ?>.</h1>
                    </div>
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                            This day Earnings</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            ₱
                                            <?php
                                            $res = mysqli_query($conn, "SELECT * FROM `todayearnings` WHERE 1");
                                            $row = mysqli_fetch_assoc($res);
                                            if ($row['todaysEarnings'] == null) {
                                                echo 0;
                                            } else {
                                                echo $row['todaysEarnings'];
                                            }
                                            ?>
                                        </div>
                                    </div>
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            ₱
                                            <?php
                                            $res = mysqli_query($conn, "SELECT * FROM `monthearnings` WHERE 1");
                                            $row = mysqli_fetch_assoc($res);
                                            if ($row['monthEarnings'] == null) {
                                                echo 0;
                                            } else {
                                                echo $row['monthEarnings'];
                                            }
                                            ?>
                                        </div>
                                    </div>
                        ...
                        <div class="card border-left-success shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                            This year Earnings</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            ₱
                                            <?php
                                            $res = mysqli_query($conn, "SELECT * FROM `yearearnings` WHERE 1");
                                            $row = mysqli_fetch_assoc($res);
                                            if ($row['yearEarnings'] == null) {
                                                echo 0;
                                            } else {
                                                echo $row['yearEarnings'];
                                            }
                                            ?>
                                        </div>
                                    </div>
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                            On Going Tickets</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                            $res = mysqli_query($conn, "SELECT COUNT(status) FROM tickets WHERE status = 'Open'");
                                            $row = mysqli_fetch_assoc($res);
