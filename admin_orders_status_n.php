                ...
                <div class="container-fluid">
                    ...
                    <a href='admin_order_log.php' class="btn btn-success btn-sm m-0 waves-effect"><i class="fa fa-clipboard-list"></i> Action Logs</a>
                        ...
                        <div id="work-collections" class="collection">
                            <?php
                            $sql = mysqli_query($conn, "CALL Orders('Not Paid');");
                            echo '<div>
                                <div>
                                    <ul class="collection">';
                                        ...
                                        $sql1 = mysqli_query($conn2, "SELECT * FROM `order_fruit` WHERE orderId = $order_id");
                                        $sql3 = mysqli_query($conn3, "SELECT * FROM `customer` WHERE customerId = $customer_id");
                                        ...
                                        $sql2 = mysqli_query($conn4, "SELECT * FROM fruit WHERE fruitId = $fruit_id;");
