                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <?php
                            ...
                            ?>
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h1 class="h3 mb-0 text-gray-800">Are you sure you want to delete <span style="color:#cc0000"><?php echo $row['name']; ?></span> from listing?</h1>
                            </div>
                            <form method="post">
                            <input type="hidden" name="fid" value="<?php echo $fruit_id ?>"></input>
                            <a href="admin_products.php" class="btn btn-success">Cancel</a>
                            <button class="btn btn-danger" type="submit" name="dbtn">Delete</button>
                            </form>
                            <?php
                            if (isset($_POST['dbtn'])) {
                                $fid = $_POST['fid'];
                                $sql = "DELETE FROM `fruit` WHERE `fruit`.`fruitId` = '$fid'";
